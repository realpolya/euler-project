...
def product_in_grid(length=4, grid_width=20, grid=grid_to_list()):
      ...
      for i in range(grid_width - length + 1): 

            end_y = last_row - ((length - 1) * grid_width) + i + 1
            
            for y in range(i, end_y, grid_width):
      ...
      for i in range(length - 1, grid_width, 1):
...
print("Answer to problem 11: ", product_in_grid())