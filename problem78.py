    ...
    for n in range(1, limit + 1):
        ...
        for penta in pentagonals:
            ...
            if add_n >= 0:
                ...
                if positive:
                    print("POSITIVE")
                    print("adding to p which is ", p, "the following p_list[add_n]", p_list[add_n])
                    p += p_list[add_n]
                    positive_tracker += 1
                else:
                    print("NEGATIVE")
                    print("subtracting from p which is ", p, "the following p_list[add_n]", p_list[add_n])
                    p -= p_list[add_n]
                    positive_tracker -= 1
